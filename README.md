...
| --- | --- | --- | --- | --- | --- |
| :small_orange_diamond: | if | `if [condition]` | <li>Boolean: <br>condition needs to evaluate to true</li> | When If condition evaluates to true, execute the nested command(s).
