...
| --- | --- | --- | --- | --- | --- |
| :small_orange_diamond: | if | `if [condition]` | :pencil2: Boolean: <br>condition needs to evaluate to true | When If condition evaluates to true, execute the nested command(s).
| :small_orange_diamond: | else if | `else if [condition]` | :pencil2: Boolean: <br>condition needs to evaluate to true | When else if condition evaluates to true, execute the nested command(s). | Note: must be placed directy below an if codeblock. | 
