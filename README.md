...
| --- | --- | --- | --- | --- | --- |
| :small_orange_diamond: | if | ```applescript if [condition]``` | Boolean: condition needs to evaluate to true | When If condition evaluates to true, execute the nested command(s).
