...
| --- | --- | --- | --- | --- | --- |
| :small_orange_diamond: | if | `if [condition]` | <ul><li>Boolean: <br>condition needs to evaluate to true</li></ul> | When If condition evaluates to true, execute the nested command(s).
